...
class ButtonPage extends qx.ui.container.Composite {
    ...
    createVariantSection() {
        ...
        const variantsContainer = new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
    ...
    createSizeSection() {
        ...
        const card = new BsCard();
        card.setMaxWidth(this.__isMobile() ? this.__responsiveWidth - 40 : 520);
        const sizesContainer = new qx.ui.container.Composite(new qx.ui.layout.VBox(16));
    ...
    createWithIconSection() {
        ...
        const card = new BsCard();
        card.setMaxWidth(this.__isMobile() ? this.__responsiveWidth - 40 : 520);
        const iconContainer = new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
    ...
    createDisabledSection() {
        ...
        const card = new BsCard();
        card.setMaxWidth(this.__isMobile() ? this.__responsiveWidth - 40 : 520);
        const disabledContainer = new qx.ui.container.Composite(new qx.ui.layout.HBox(12));
