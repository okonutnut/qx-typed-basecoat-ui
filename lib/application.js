class AppColors {
    static resolveCssVar(cssVarName, fallback) {
        ...
        this.__cache.set(cacheKey, fallback !== null && fallback !== void 0 ? fallback : "");
        return fallback !== null && fallback !== void 0 ? fallback : "";
    }
    static primary() {
    ...
    static sidebarForeground() {
        return this.resolveCssVar("--color-sidebar-foreground", "oklch(0.2795 0.0368 260.0310)");
    }
...
function qooxdooMain(app) {
    ...
    const appConfig = Object.assign(Object.assign({}, DEFAULT_APP_CONFIG), { appName: "QX-Typed App", appVersion: "1.0.0", user: { name: "User", role: "Role" }, login: {
    ...
    const createMainLayout = () => {
        ...
        const mainLayout = new MainLayout(initialPage, sidebarItems, pageMap, initialTitle, appConfig);
...
class BsCombobox extends qx.ui.basic.Atom {
    ...
    __renderTrigger() {
        ...
        const classes = ["btn-outline", "w-[200px]", this.__className, disabledClass]
            .filter(Boolean)
            .join(" ");
...
function createSidebarItems(definitions = ROUTE_DEFINITIONS) {
...
class SliderPage extends qx.ui.container.Composite {
    constructor() {
        super(new qx.ui.layout.VBox(20));
        this.__responsiveWidth = 0;
        this.setPadding(20);
